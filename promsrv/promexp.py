...
class Metric():
    ...
    def __init__(self, name: str, datatype: str, helpstr: str, # pylint: disable=too-many-arguments
                 timeout: float | None = None, with_update_counter: bool=False):
        self._name = name
    ...
    def set(self, labels: dict[str, str], value: float|None) -> None:
...
class PrometheusExporter():
    ...
    def register(self, name: str, datatype: str, helpstr: str, # pylint: disable=too-many-arguments
                 timeout:float|None=None, with_update_counter:bool=False) -> None:
